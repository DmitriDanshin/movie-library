<template>
  <div class="container mx-auto flex justify-center mt-5 p-2 md:p-0 bg-white">
    <genres-editor
      v-if="isGenresEditorOpened"
      @back="isGenresEditorOpened = false"
      @get-genre="addGenreToGenres"
      :item-genres="genres"
    />
    <div v-if="!isGenresEditorOpened" class="w-full max-w-xs">
      <form class="bg-white shadow-md px-8 pt-6 pb-8 mb-4 shadow-lg">
        ...
        <div class="mb-4">
          <button
            @click="isGenresEditorOpened = true"
            class="
              bg-blue-500
              hover:bg-blue-700
              text-white
        ...
        <div class="mb-4 flex justify-between">
          <div class="block">
            ...
            <select class="mt-2" v-model="country">
              <option v-for="country in handledListOfCountries" :key="country">
                {{ country }}
              </option>
            </select>
          </div>
