<template>
  <div
    :class="isFavorite ? 'border-blue-300' : 'border-gray-300'"
    @click="switchToFavorite"
    class="item border bg-white shadow-lg rounded-lg p-10"
  >
    <img
      class="w-48 h-48 mx-auto"
      src="https://i.imgur.com/oX0hGJs.jpeg"
      alt=""
    />
    ...
    <div class="flex justify-center mt-2">
      ...
      <button
        v-if="!isEditMode"
        class="rounded-md bg-gray-800 text-white p-1 px-4 ml-2"
    ...
    <div class="description mt-5">
      ...
      <div class="grid grid-cols-3 gap-2 mt-4">
        <div
          ...
          :class="
            genre.color === 'bg-black' ? 'bg-black text-white' : genre.color
          "
